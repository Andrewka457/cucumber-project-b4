...
public class DocuportConstants {
    ...
    public static final String EXPECTED_HEADER_CHOOSE_ACCOUNT = "Choose account";
    ...
    public static final String USERNAME_ERROR_MESSAGE = "Please enter your username or email address";
